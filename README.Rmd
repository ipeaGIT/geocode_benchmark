...
timings <- rbind(old_server_timings, new_server_timings, third_server_timings)
...
ggplot(timings) +
  ...
  scale_color_discrete("Servidor", labels = c("Novo", "Antigo", "Terceiro")) +
...
ggplot(melted_timings) +
  ...
  facet_wrap(
    ~ server,
    nrow = 1,
    labeller = as_labeller(c("new" = "Novo", "old" = "Antigo", "third" = "Terceiro"))
  ) +
  scale_y_continuous(
